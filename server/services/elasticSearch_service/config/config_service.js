...
const {addDoc, deleteDoc} = require("../utils/elastic_sync");


//Kết nối đến RabbitMQ server
const receivedHandleElatic = async ()=>{
    try {
    ...
    console.log(`[Service handle Elastic] Waiting for messages with binding key ${bindingKey}`);
